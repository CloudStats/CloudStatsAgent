  ...
  def self.serialize(server_key, sysinfo)
    {
      ...
      server: {
        ...
        connections_tcp: sysinfo.safe_get(:network, :connections_tcp),
        connections_udp: sysinfo.safe_get(:network, :connections_udp),
        connections_tcp6: sysinfo.safe_get(:network, :connections_tcp6),
        connections_udp6: sysinfo.safe_get(:network, :connections_udp6),
        ...
        top_cpu_graph:   sysinfo.safe_get(:processes, :top_cpu_graph),
        top_mem_graph:   sysinfo.safe_get(:processes, :top_mem_graph),
